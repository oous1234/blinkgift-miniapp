...
// Маленькая иконка подарка (для списка поиска)
export const GiftIconMini = (props: IconProps) => (
  <Icon
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
// Большая лупа для пустого состояния поиска
export const SearchIconBig = (props: IconProps) => (
  <Icon
    viewBox="0 0 24 24"
    boxSize="64px"
    fill="none"
...
export const MarketIcon = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M17 6h-2V5c0-1.65-1.35-3-3-3S9 3.35 9 5v1H7c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-5-2c.55 0 1 .45 1 1v1h-2V5c0-.55.45-1 1-1zm5 15H7V8h2v2c0 .55.45 1 1 1s1-.45 1-1V8h2v2c0 .55.45 1 1 1s1-.45 1-1V8h2v11z" />
  </Icon>
)
...
export const SearchIconSolid = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const NftIcon = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM8.5 10c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm10 9H5.5l3.5-4.5 2.5 3 3.5-4.5 4 6z" />
  </Icon>
)

export const StarsIcon = (props: IconProps) => (
    <Icon viewBox="0 0 24 24" fill="#FFD700" {...props}>
        <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
    </Icon>
)

export const TonIconBlue = (props: IconProps) => (
    <Icon viewBox="0 0 56 56" fill="none" {...props}>
