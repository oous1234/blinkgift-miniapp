...
interface AttributePickerProps {
  ...
  onBack: () => void
  getImageUrl?: (item: any) => string // Используем обычный PNG
            ...
            {filtered.map((item, idx) => {
              ...
              return (
                <Box
                  ...
                  cursor="pointer"
                  transition="all 0.2s"
                  _active={{ transform: "scale(0.92)", bg: "whiteAlpha.200" }}
                >
                  <Center h="70px" mb={1}>
                  ...
                  <Text fontSize="10px" fontWeight="800" textAlign="center" color="whiteAlpha.800" isTruncated px={1}>
                    {name}
                  </Text>
                </Box>
              )
